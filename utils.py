...
class WeightedDiceLoss(nn.Module):
    def __init__(self, weights=[0.8, 0.2]): # W_pos=0.8, W_neg=0.2,  #0.5,0.5
...
class WeightedDiceBCE(nn.Module):
    def __init__(self,dice_weight=1,BCE_weight=1):
        ...
        self.BCE_loss = WeightedBCE(weights=[0.6, 0.4])  ##0.5, 0.5
        self.dice_loss = WeightedDiceLoss(weights=[0.6, 0.4])  #0.5,0.5
